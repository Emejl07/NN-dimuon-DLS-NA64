...
std::vector<ROOT::RDF::RResultPtr<TH1>> doHisto(ROOT::RDF::RNode df, int icut, string cutName) {
 ...
 ret.push_back(df.Histo1D( { Form("DIMUn_E_%i", icut), "DIMUn_E", 100u, 0., 100.}, "DIMUn_E"));
  ...
  ret.push_back(df.Histo1D( { Form("PION_ZProd_%i", icut), "PION_ZProd", 1000u, -20000., -19000. }, "PION_ZProd"));
  ret.push_back(df.Histo1D( { Form("PION_ZDecay_%i", icut), "PION_ZDecay", 1000u, -20000., 4000. }, "PION_ZDecay"));
  ret.push_back(df.Histo1D( { Form("PION_Weight_%i", icut), "PION_Weight", 10000u, 0.002455, 0.002457 }, "AWeight"));

  ret.push_back(df.Histo2D( { Form("PION_Decay_%i", icut), "Weight; PION ZDecay [mm]; Weight ", 10000u, -20000., 4000., 10000u, 0.002455, 0.002457, }, "PION_ZDecay", "AWeight"));
  ret.push_back(df.Histo2D( { Form("PION_Prod_%i", icut), "Weight; PION ZProd [mm]; Weight", 10000u, -20000., 4000., 10000u, 0.002455, 0.002457 }, "PION_ZProd", "AWeight"));

 // ret.push_back(df.Histo1D( { Form("KAON_ZProd_%i", icut), "KAON_ZProd", 10000u, -20000., 4000. }, "KAON_ZProd"));
 // ret.push_back(df.Histo1D( { Form("KAON_ZDecay_%i", icut), "KAON_ZDecay", 10000u, -20000., 4000. }, "KAON_ZDecay"));
 // ret.push_back(df.Histo1D( { Form("KAON_Weight_%i", icut), "KAON_Weight", 10000u, 0., 1. }, "AWeight"));
...
void pion_ana(string fIn = "", string fOut = "") {
  ...
  postCutProcess(1, "EC < 76 && PS > 0.4", d1, 0);
...
// ------------------------------------------------------------------------------------------------------------ //
  ...
  auto dBlind_ord = d1.Filter("eH0_blind > 4 && eH1_blind > 4 && eH2_blind > 4");
  postCutProcess(0, "AllEvents", d1, 1);
  auto dF1_ord = d1.Filter(physTrigger, { "ECALpenergy", "ECALenergy" });
  postCutProcess(1, "EC < 76 && PS > 0.4", d1, 1);
